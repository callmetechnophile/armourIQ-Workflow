...
def run_planning(validation_results: Dict[str, Any], receipt_dict: Dict[str, Any], target_days: int = 22) -> Dict[str, Any]:
    # Generate structured roadmap
    roadmap = invoke_tool(
        agent_name="Planning Agent",
        tool_name="generate_roadmap",
        args={"validation_results": validation_results, "target_days": target_days},
